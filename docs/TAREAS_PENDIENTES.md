...
>
> **Última actualización:** 2026-09-17 (sesiones en paralelo con acceso real a `bestronger-vps`: 1.1 cerrada del todo — `--confidence-gate` probado con casos ambiguos reales contra un catálogo nuevo y norma de asignación manual establecida; 1.2 confirmada ya aplicada en producción; 1.4 resuelto — volcado inicial de 6 perfiles reales a `bstronger-memoria-clientes`; 2.3 parcial — Borja resuelto, Toni sigue abierto a propósito; 2.6 resuelto — repo privado `ilzarpeatore/bstronger-memoria-clientes` creado; 2.7 resuelto — módulo `habitos-prioritarios.md` en el agente de nutrición)
